...
function process(reslist:ICalendarEvent[], start:any, end:any, ics:any, kalEv:CalendarEvents) {
...
export async function ICloud(whenMoment:moment.Moment, config: Config, kalEv:CalendarEvents) {
    //@ts-ignore
